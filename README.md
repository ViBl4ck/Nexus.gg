...
![alt text](image.png)
Demo
🔗 Ver demo ao vivo <!-- coloque o link do Vercel/Netlify aqui -->
Funcionalidades
...
Rodando localmente
bashgit clone https://github.com/seu-usuario/nexus-gg.git
cd nexus-gg
Abra index.html no navegador. Pronto.

Para evitar problemas com file:// em alguns navegadores, recomendo usar a extensão Live Server do VS Code ou npx serve.
...
Autor
Vítor Camargo — seu-portfolio.com · [LinkedIn](https://www.linkedin.com/in/vitor-cso-ti/) · [GitHub](https://github.com/ViBl4ck)
Licença
MIT
